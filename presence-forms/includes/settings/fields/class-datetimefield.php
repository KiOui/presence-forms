...
if ( ! class_exists( 'DateTimeField' ) ) {
	...
	class DateTimeField extends SettingsField {
		 ...
		 */
		public function __construct( string $id, string $name, ?DateTime $default, ?callable $renderer = null, bool $can_be_null = false, string $hint = '', ?array $conditions = null, ?array $subscribers = null ) {
